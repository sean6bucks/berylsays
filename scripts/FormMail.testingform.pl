...
BEGIN
{
  ...
  $postmaster        = 'formmail@gmail.com';
  @referers          = (berylchung.com staging.berylchung.com www.berylchung.com);
  @allow_mail_to     = 'sean6bucks@gmail.com';
  @recipients        = ();
  %recipient_alias   = ();
...
<p>
  ...
  like this:
  <tt>&lt;form action=&quot;/cgi-bin/FormMail.testingform.pl&quot; method=&quot;post&quot;&gt;</tt>
</p>
END
    return 0;
  }
...
sub send_main_email_header {
  ...
  my $subject = $self->{FormConfig}{subject} || 'Sayign Hi';
  if ($self->{CFG}{secure}) {
...
sub success_page_html_preamble {
  ...
  my $title = $self->escape_html( $self->{FormConfig}{'title'} || 'Hey now' );
...
sub success_page_footer {
  ...
  print <<END;
        <hr size="1" width="75%" />
        Click <a href="http://www.berylchung.com">here</a> to return to the site.
        </body>
       </html>
END
}
